...
namespace BlogApp.Services.Concrete
{
    public class CategoryManager : ManagerBase,ICategoryService
    {
        ...
        public async Task<IDataResult<CategoryDto>> GetAsync(int categoryId)
        {
            ...
            return new DataResult<CategoryDto>(ResultStatus.Error, CategoryMessages.CategoryNotFoundSingular, new CategoryDto
            {
                Category = null,
                ResultStatus = ResultStatus.Error,
                Message = CategoryMessages.CategoryNotFoundSingular
            });
        }
        ...
        public async Task<IDataResult<CategoryUpdateDto>> GetCategoryUpdateDtoAsync(int categoryId)
        {
            ...
            {
                return new DataResult<CategoryUpdateDto>(ResultStatus.Error, CategoryMessages.CategoryNotFoundSingular, null);
            }
        }
        ...
        public async Task<IDataResult<CategoryListDto>> GetAllAsync()
        {
            ...
            return new DataResult<CategoryListDto>(ResultStatus.Error, CategoryMessages.CategoryNotFoundPlural, new CategoryListDto
            {
                Categories = null,
                ResultStatus = ResultStatus.Error,
                Message = CategoryMessages.CategoryNotFoundPlural
            });
        }
        ...
        public async Task<IDataResult<CategoryListDto>> GetAllByNonDeletedAndActiveAsync()
        {
            ...
            return new DataResult<CategoryListDto>(ResultStatus.Error, CategoryMessages.CategoryNotFoundPlural, null);
        }
        ...
        public async Task<IDataResult<CategoryDto>> AddAsync(CategoryAddDto categoryAddDto, string createdByName)
        {
            ...
            return new DataResult<CategoryDto>(ResultStatus.Success, CategoryMessages.Add(addedCategory.Name), new CategoryDto
            {
                Category = addedCategory,
                ResultStatus = ResultStatus.Success,
                Message = CategoryMessages.Add(addedCategory.Name)
            });
        }
        ...
        public async Task<IDataResult<CategoryDto>> UpdateAsync(CategoryUpdateDto categoryUpdateDto, string modifiedByName)
        {
            ...
            await UnitOfWork.SaveAsync();
            return new DataResult<CategoryDto>(ResultStatus.Success, CategoryMessages.Update(updatedCategory.Name), new CategoryDto
            {
                Category = updatedCategory,
                ResultStatus = ResultStatus.Success,
                Message = CategoryMessages.Update(updatedCategory.Name)
            });
        }
        ...
        public async Task<IDataResult<CategoryDto>> DeleteAsync(int categoryId, string modifiedByName)
        {
            ...
            if (category != null)
            {
                ...
                await UnitOfWork.SaveAsync();
                return new DataResult<CategoryDto>(ResultStatus.Success, CategoryMessages.Delete(deletedCategory.Name), new CategoryDto
                {
                    Category = deletedCategory,
                    ResultStatus = ResultStatus.Success,
                    Message = CategoryMessages.Delete(deletedCategory.Name)
                });
            }
            return new DataResult<CategoryDto>(ResultStatus.Error, CategoryMessages.CategoryNotFoundSingular, new CategoryDto
            {
        ...
        public async Task<IDataResult<CategoryDto>> UndoDeleteAsync(int categoryId, string modifiedByName)
        {
            ...
            if (category != null)
            {
                ...
                var deletedCategory = await UnitOfWork.Categories.UpdateAsync(category);
                await UnitOfWork.SaveAsync();
                return new DataResult<CategoryDto>(ResultStatus.Success, CategoryMessages.UndoDelete(deletedCategory.Name), new CategoryDto
                {
                    Category = deletedCategory,
                    ResultStatus = ResultStatus.Success,
                    Message = CategoryMessages.UndoDelete(deletedCategory.Name)
                });
            }
            return new DataResult<CategoryDto>(ResultStatus.Error, CategoryMessages.CategoryNotFoundSingular, new CategoryDto
            {
        ...
        public async Task<IResult> HardDeleteAsync(int categoryId)
        {
            ...
            if (category != null)
            {
                ...
                await UnitOfWork.SaveAsync();
                return new Result(ResultStatus.Success, CategoryMessages.HardDelete(category.Name));
            }
            return new Result(ResultStatus.Error, CategoryMessages.CategoryNotFoundSingular);
        }
